...
const About = () => {
    return (
      ...
      <span className="mt-5 text-6xl font-semibold"> About ProjeXplore.</span>
      ...
      <div class="flex justify-center h-screen mt-4">
        <div class="relative group">
          <Link to="/" class="no-underline relative inline-block p-px font-semibold leading-6 text-white bg-gray-800 shadow-2xl cursor-pointer rounded-xl shadow-zinc-900 transition-transform duration-300 ease-in-out hover:scale-105 active:scale-95">
